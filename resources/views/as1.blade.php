...
<td class="txtbx1"><br><br><input type="checkbox" id="chkbx4" name="clubm" value="Boat">
  <label for="vehicle3"> Club Membership</label>
  <br><br><input type="checkbox" id="chkbx5" name="imsurancep" value="Boat">
  <label for="vehicle3"> Insurance Policy</label></td></tr>
  <tr><td class="txtbx1">Cycling Experience:&emsp;</td>
